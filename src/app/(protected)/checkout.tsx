  ...
  if (!cartItems || cartItems.length === 0) {
    return (
      <View className="flex-1 bg-[#0D1117] items-center justify-center">
        ...
        <Pressable
          className="mt-4 bg-[#4A90E2] py-2 px-4 rounded-sm"
    ...
    <View className="flex-1 bg-[#0D1117]">
      ...
      <ScrollView className="flex-1" contentContainerStyle={{ paddingTop: 16 }}>
        ...
        <View className="px-4 mb-6">
          ...
          <Pressable
            className="bg-[#161B22] p-4 rounded-sm"
        ...
        <View className="px-4 mb-6">
          ...
          <View className="gap-3 space-y-4">
            <TextInput
              className="bg-[#161B22] text-white px-4 py-3 rounded-sm"
              placeholder="Name"
            ...
            <View className="flex-row gap-3 space-x-4">
              <TextInput
                className="bg-[#161B22] text-white px-4 py-3 rounded-sm flex-1"
                placeholder="MM/YY"
                placeholderTextColor="#666"
                value={expiryDate}
        ...
        <View className="px-4 mb-6">
          ...
          <Pressable
            className="bg-[#4A90E2] py-4 rounded-sm"
